public class DaggerMushAttackThrowState : EnemyState
{

    private readonly DaggerMush daggerMush;

    public DaggerMushAttackThrowState(Enemy _enemy, EnemyStateMachine _stateMachine, string _animBoolName) : base(_enemy, _stateMachine, _animBoolName)
    {
